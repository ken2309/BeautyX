...
const searchResultSlice = createSlice({
    ...
    extraReducers: {
        ...
        [fetchServicesByFilter.pending]: (state) => {
            return { ...state, RE_SERVICES: { ...state.RE_SERVICES, status: STATUS.LOADING } }
        },
        ...
        [fetchServicesByFilter.rejected]: (state) => {
            return { ...state, RE_SERVICES: { ...state.RE_SERVICES, status: STATUS.FAIL } }
        },


        [fetchProductsByFilter.pending]: (state) => {
            return { ...state, RE_PRODUCTS: { ...state.RE_PRODUCTS, status: STATUS.LOADING } }
        },
        ...
        [fetchProductsByFilter.rejected]: (state) => {
            return { ...state, RE_PRODUCTS: { ...state.RE_PRODUCTS, status: STATUS.FAIL } }
        },
    }
})
