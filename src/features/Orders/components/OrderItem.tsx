...
function OrderItem(props: IProp) {
  ...
  const checkStatus = (status: string) => {
    switch (status) {
      case "CANCELED":
        return <div style={{ backgroundColor: "var(--red-cl)" }} className="status">Đã hủy</div>;
      ...
      case "PENDING":
        return <div style={{ backgroundColor: "var(--red-cl)" }} className="status">Đã hủy</div>;
      case "PAID":
        return <div style={{ backgroundColor: "var(--green)" }} className="status">Đã thanh toán</div>;
      default:
        break;
    }
  };
      ...
      <li>
        <div className="order-item">
          ...
          <div className="flex-row-sp order-item__date">
            ...
            <span className="right">{formatDate(order?.created_at)}</span>
          </div>
          <div className="flex-row-sp order-item__body">
            <img src={order?.organization?.image_url} alt="" className="order-item__body-img" />
          ...
          <div className="flex-row-sp order-item__status">
            ...
            <div className="flex-row right">
              <span className="order-amount">{formatPrice(order?.payment_gateway?.amount)}đ</span>
