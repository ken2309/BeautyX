...
function OrgSearch(props: any) {
    ...
    const { SERVICES_KEYWORD, PRODUCTS_KEYWORD } = useSelector((state: any) => state.ORG);
    const [tab, setTab] = useState(1);
    const tabs = useMemo(() => (
        [
            { id: 1, title: "Dịch vụ", total: SERVICES_KEYWORD.total_services },
            { id: 2, title: "Sản phẩm", total: PRODUCTS_KEYWORD.total_products }
        ]
                                            ...
                                            style={item.id === tab ?
                                                {
                                                    ...
                                                    borderBottom: "solid 1px var(--text-black)"
                                                }
                                                :
                                                {}}
                                            className="tab-item"
